        ...
        <section className='bg-black'>
            <Padding className='space-y-20 py-24'>
                ...
                <div className='flex w-full justify-center h-auto relative
                    after:absolute after:content-[" "] after:w-[5px] after:h-full after:bg-gradient-to-b after:bg-line-gradient'>
                    <ul className='text-white'>
                        
                        <li className='w-1/2 h-auto px-4 py-8 border border-white rounded-lg relative z-[99] mb-8 float-left clear-right -translate-x-7'>
                            <h2 className='font-bold text-2xl'>The Software</h2>
                            <span className='border border-black w-6 h-6 bg-white rounded-full absolute top-1/2 -translate-y-1/2 -right-[14px] translate-x-7
                        ...
                        <li className='w-1/2 h-auto px-4 py-8 border border-white rounded-lg relative z-[99] mb-8 float-right clear-left translate-x-7'>
                            <h2 className='font-bold text-2xl'>Build</h2>
                            <span className='border border-black w-6 h-6 bg-white rounded-full absolute top-1/2 -translate-y-1/2 -left-[14px] -translate-x-7'></span>
                        ...
                        <li className='w-1/2 h-auto px-4 py-8 border border-white rounded-lg relative z-[99] mb-8 float-left clear-right -translate-x-7'>
                            ...
                            <span className='border border-black w-6 h-6 bg-white rounded-full absolute top-1/2 -translate-y-1/2 -right-[14px] translate-x-7'></span>
